...
void test24()
{
    ...
    //std::cout << "before erase: " << lar << std::endl;

    ////lar.erase(3);
    ////lar.erase(8);
    ////lar.erase(9);

    ////std::cout << "after erase: " << lar << std::endl;

    //lar.compact();

    //std::cout << "after compact: " << lar << std::endl;
    ...
    run_scenario_cmp_to_vector<4>( // node size
            2000,      // num operations
            4, 1,       // insert, erase
...
void (*pTests[])(void) = {/*test0,  test1,  test2,  test3,  test4,  test5,  test6,  test7,  test8,
